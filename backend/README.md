...
## Project Structure
    ...
    ├── testapiautoconnecto_77734  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_77734`
...
2. Clone this repo and `cd testapiautoconnecto_77734`
